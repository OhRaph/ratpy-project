""" RapData UnderCream Spiders module """

import bs4
import ratpy

from projects.rapdata.spiders.undercream.parser import Parser
from projects.rapdata.spiders.undercream import items

# ############################################################### #
# ############################################################### #


class UnderCream(ratpy.SubSpider):

    name = 'rapdata.spiders.undercream'
    regex = 'undercream\\.com/category/all-contries/france(/page/[0-9]+)?'
    linker = True
    activated = True
    ...
    def start_links(self):
        yield ratpy.URL('https://undercream.com/category/all-contries/france')
